...
public class Portola {
	...
	public static void main(String[] args) {
		...
		//driver.findElement(By.className("onclick")).click();
		//driver.findElement(By.xpath("//*[@id='request_type']/div[4]/a")).click();
		//Multiple window concept-
		//driver.findElement(By.xpath("//*[@id='cookie_action_close_header']")).click();
		//driver.findElement(By.cssSelector("#request_type > div.pr-btn-row > a")).click();
		//driver.findElement(By.xpath("//*[@id='cookie_action_close_header']")).click();
